    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparentd">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="logo">
                <h1 class="text-light"><a href="home"><span>FARMER EXPORTER LINKAGE</span></a></h1>
            ...
            <?php if(Auth::logged_in()):?>
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu mt-3  dropdown-menu-end " >
                        ...
                        <div class="dropdown-item"><i class="bi bi-box-arrow-right text-warning pe-3"></i> <a href="logout">Sign Out</a></div>
                    </ul>
                </div>
            <?php else: ?>
